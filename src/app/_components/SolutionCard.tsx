...
export default function SolutionCard({ icon, title, overviewText, services }: SolutionCardProps) {
  ...
  return (
    <div className="bg-background-secondary rounded-2xl p-8 h-full border border-gray-700 hover:border-accent-cyan transition-all duration-300">
      {/* Icon and Title */}
      ...
      {/* Overview Text */}
      <p className="text-text-body mb-6 leading-relaxed">{overviewText}</p>
