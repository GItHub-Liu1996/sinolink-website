  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h1 
          className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 sm:mb-8 font-sans leading-tight animate-fade-in"
          style={{ color: '#FFFFFF' }}
        >
        ...
        <p 
          className="text-base sm:text-xl md:text-2xl text-white mb-8 sm:mb-12 max-w-4xl mx-auto font-body leading-relaxed animate-fade-in-delayed"
          style={{ color: '#FFFFFF' }}
        >
          From WFOE registration to ongoing compliance, our expert team provides the clarity and support you need to succeed.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center animate-fade-in-delayed">
